...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_sign_in_log_in_button:
                ...
                break;
            case R.id.activity_sign_in_facebook_imageButton:
                if (!handleFacebookButton()) {
    ...
    private boolean handleLogInButton() {
        //TODO: Log-in button was clicked!
        //Test
    ...
    private boolean handleFacebookButton() {
        //TODO: Facebook button was clicked!
